...
#define kCompleteRPCURL  @"webviewprogress:///complete"
...
@interface HBWebLoadingView : UIView
@end

@implementation HBWebLoadingView
...
//@property (nonatomic,readonly)  HBNavigationbar *navigationBar;          /* Navigation bar shown along the top of the view */
...
@property (nonatomic,strong)    HBWebLoadingView *loadingBarView;        /* The loading bar, displayed when a page is being loaded */
...
#pragma clang diagnostic pop
    ...
    CGFloat y = HEIGHT_NAVIGATIONBAR - LOADING_BAR_HEIGHT;
    self.loadingBarView = [[HBWebLoadingView alloc] initWithFrame:CGRectMake(0, y, CGRectGetWidth(self.view.frame), LOADING_BAR_HEIGHT)];
...
//    if (self.navigationButtonsHidden == NO)
    ...
    self.webView.frame = CGRectMake(0, HEIGHT_NAVIGATIONBAR, UISCREEN_WIDTH, HEIGHT_NAVIGATIONCTR - CGRectGetHeight(self.toolbar.frame));
    [self.toolbar setBackgroundColor:JXL_COLOR_THEME];
}
...
- (void)willAnimateRotationToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration
{
    ...
    self.loadingBarView.frame = ({
        ...
        frame.origin.y =  HEIGHT_NAVIGATIONBAR - LOADING_BAR_HEIGHT ; //self.webView.scrollView.contentInset.top;
...
//{
//    if (self.navigationController)
//        return  self.navigationBar;//self.navigationController.navigationBar;
//    
//    return nil;
//}
...
//{
//    if (!_webview) {
//        _webview = [[UIWebView alloc] initWithFrame:CGRectMake(0, HEIGHT_NAVIGATIONBAR, UISCREEN_WIDTH, HEIGHT_NAVIGATIONCTR)];
