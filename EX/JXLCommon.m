...
+(UIView *)BigCenterButtonview:(CGRect)frame btnframe:(CGRect)buttonFrame title:(NSString *)title target:(id)target sel:(SEL)selector
{
    ...
    UIButton * button = [ToolsFunc CreateButtonWithFrame:buttonFrame andTxt:title];
...
+(UIView *)BigButtonview:(CGRect)frame btnframe:(CGRect)buttonFrame title:(NSString *)title target:(id)target sel:(SEL)selector
{
    UIView * view = [[UIView alloc] initWithFrame:frame];
    UIButton * button = [ToolsFunc CreateButtonWithFrame:buttonFrame andTxt:title];
    button.backgroundColor = JXL_COLOR_THEME_NAVIGATIONBAR;
...
{
    return [JXL_Common cell_x_x_struct:title detailvalue:nil footerheight:0 selectionStyle:YES accessory:YES picture:nil target:target selectAction:selectAction];
}
...
{
    return [JXL_Common cell_x_x_struct:title detailvalue:detailvalue footerheight:footerheight selectionStyle:selectionStyle accessory:accessory picture:nil target:target selectAction:selectAction ];
}
...
{
    return [JXL_Common cell_x_x_struct:title detailvalue:detailvalue footerheight:footerheight selectionStyle:selectionStyle accessory:accessory cellheight:40 imageRight:NO imageCornerRadius:NO  picture:picture target:target selectAction:selectAction background:[UIColor whiteColor]];
}
...
{
    return [JXL_Common cell_x_x_struct:title detailvalue:detailvalue footerheight:footerheight selectionStyle:selectionStyle accessory:accessory cellheight:40 imageRight:NO imageCornerRadius:NO  picture:picture target:target selectAction:selectAction background:backgroundcolor];
}
...
{
    return [JXL_Common cell_x_x_struct:title detailvalue:detailvalue footerheight:footerheight selectionStyle:selectionStyle accessory:accessory cellheight:cellheight imageRight:imageRight imageCornerRadius:imageCornerRadius picture:picture target:target selectAction:selectAction background:backgroundcolor titlecolor:@"black"];
}
...
{
    CELL_STRUCT * cell1_0 = [[CELL_STRUCT alloc] initWithtitle:title cellclass:@"BaseTableViewCell" placeholder:@"" accessory:NO sel_selctor:selectAction delegate:target];
